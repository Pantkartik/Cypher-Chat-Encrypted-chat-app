...
import { Eye, EyeOff, Lock, Mail, User, Github, Chrome, Check, X, Shield, Zap, ArrowRight } from "lucide-react"
        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Create your account and experience end-to-end encrypted conversations with a modern, intuitive interface designed for privacy-conscious users.
            </p>
          </div>
        ...
        >
          <div className="bg-card/50 backdrop-blur-lg rounded-2xl p-8 border border-border/30 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Sign up to get started with secure messaging</p>
            </div>

            {error && (
              <div className="bg-destructive/20 border border-destructive/30 text-destructive px-4 py-3 rounded-lg text-sm mb-6">
                {error}
              </div>
            )}
